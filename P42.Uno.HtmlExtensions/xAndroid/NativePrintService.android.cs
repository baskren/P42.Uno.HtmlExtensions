...
internal class NativePrintService : INativePrintService
{
...
#pragma warning restore CA1422 // Validate platform compatibility
    ...
    private static async Task OnPageFinishedAsync(Android.Webkit.WebView webView, string jobName, PageSize pageSize, PageMargin margin, TaskCompletionSource<ToFileResult> taskCompletionSource)
    {
        if (string.IsNullOrWhiteSpace(jobName))
            jobName = AppInfo.Name;
        var printMgr = (PrintManager)Activity.GetSystemService(Context.PrintService);
