...
internal static class AndroidWebViewExtensions
{
    ...
    {
        if (webView2 is ViewGroup group)
        {
    ...
    public static int ContentWidth(this Android.Webkit.WebView webView)
    {
        ...
        var width = (int)method.Invoke(webView, []);
        return width;
    }
    ...
    public static int ContentHeight(this Android.Webkit.WebView webView)
    {
        ...
        var height = (int)method.Invoke(webView, []);
...
{
    public TaskCompletionSource<Java.Lang.Object> TaskCompletionSource = new();
