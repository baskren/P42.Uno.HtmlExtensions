...
public class PageSize
{
    ...
    /// <returns></returns>
    private static PageSize CreateInInches(double inchWidth, double inchHeight, [System.Runtime.CompilerServices.CallerMemberName] string callerName = null)
        => new()
        {
            Width = inchWidth * 72,
    ...
    /// <param name="callerName"></param>
    /// <returns></returns>
    private static PageSize CreateInMillimeters(double mmWidth, double mmHeight, [System.Runtime.CompilerServices.CallerMemberName] string callerName = null)
